  ...
  if (target === null) {
    return (
      <div className="mt-5 flex flex-col gap-3 rounded-2xl border border-border/50 bg-muted/15 p-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button variant="primary" size="sm" disabled={masked} onClick={onAdd} className="shrink-0 self-center sm:self-auto">Add a target</Button>
      </div>
    )
  }
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <article className="rounded-xl border border-primary/25 bg-primary/5 p-3">
          ...
          <div className="mt-1 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Button variant="secondary" size="sm" disabled={masked || !canUseRequired} onClick={onUseRequiredAmount} className="self-center sm:self-auto">
