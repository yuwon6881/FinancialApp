  ...
  return (
    <div className="space-y-5 rounded-2xl border border-border/50 bg-muted/15 p-4">
      <FormField
        ...
        hint="Longer forecasts have a wider range of possible outcomes."
      >
      ...
      <FormField
        ...
        hint={`${money(monthlyContribution * 12)} a year. This is only a what-if amount.`}
      >
      ...
      <div className="space-y-3 border-t border-border/50 pt-4">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <p className="mt-1 text-xs leading-relaxed text-muted-foreground">What that amount would buy at today’s prices.</p>
          </div>
        ...
        {todayMoney && (
          <FormField
            ...
            hint="Only changes the today’s-money view; it does not change the future balances themselves."
          >
