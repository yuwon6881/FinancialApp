    ...
    <div className="space-y-6 soft-rise">
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-${activeWishlistItem ? '4' : '3'} gap-4`}>
        ...
        <div 
          ...
          className="metric-card interactive-card app-panel p-6 rounded-2xl bg-card/92 border border-border/60 hover:border-blue-500/30 transition-all duration-300 group cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
