...
export function LedgerBalanceReconciliation({ category, cycleLabel, formatSensitive }: LedgerBalanceReconciliationProps) {
  ...
  return (
    <section aria-labelledby="ledger-balance-reconciliation-title" className="app-panel rounded-2xl border border-border/60 bg-card/92 p-5">
      ...
      <dl className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-[1fr_auto_1fr_auto_1fr] sm:items-center">
        <div className="rounded-xl border border-border/50 bg-muted/25 p-3">
          <dt className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">At cycle start</dt>
        ...
        <div className="rounded-xl border border-border/50 bg-muted/25 p-3">
          <dt className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Movement this cycle</dt>
        ...
        <div className="rounded-xl border border-blue-500/25 bg-blue-500/8 p-3">
          <dt className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Left after movement</dt>
