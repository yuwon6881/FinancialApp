      ...
      {navItems.map(({ tab, label, Icon, activeClass, iconClass, dotClass }) => {
        ...
        return (
          <Button
            ...
            className={`relative flex min-h-11 w-full items-center justify-center gap-2.5 rounded-xl border px-2 text-[13px] font-semibold transition duration-150 lg:justify-start lg:px-2.5 ${
              isActive
