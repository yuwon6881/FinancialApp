// Exact user-facing copy for the push notification feature. Centralized so the Settings row,
...
export const PUSH_DESCRIPTION = 'Send device notifications around 9:00 AM, even when the app is closed.'
