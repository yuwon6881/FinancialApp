...
export const PUSH_DESCRIPTION =
  'Bill reminders and spending alerts, even when this app is closed.'

export const CATEGORY_LIMIT_PUSH_DESCRIPTION =
  'Alerts as a category nears, then reaches, your planned amount.'
...
export const PUSH_ENABLED_ELSEWHERE_MESSAGE =
  'Notifications are already on for another device. Turn them on here to receive alerts on this device too.'
...
export const CATEGORY_ALERTS_NEED_DEVICE =
  'Turn on notifications for this device first. Category alerts go to every device you enable.'
