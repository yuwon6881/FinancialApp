...
function isWellFormedOp(op: unknown): op is QueuedOp {
  ...
  return (
    ...
    ['add', 'update', 'delete', 'restore', 'toggle', 'purchase', 'unpurchase', 'reminder', 'payEarly', 'settle', 'cleanup', 'bulkAdd', 'bulkDelete', 'bulkRestore', 'bulkMove', 'advanceRepayment', 'fullSettlement', 'undoRepayment'].includes(o.type as string) &&
